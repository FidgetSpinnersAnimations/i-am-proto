	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
		{
			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						var fuckingSussy = Paths.getSparrowAtlas('i-am-proto/ERRORNOTE');
						...
						switch(noteType)
						{
							case 2:
							{
								frames = Paths.getSparrowAtlas('i-am-proto/ERRORNOTE');
								animation.addByPrefix('greenScroll', 'error');
								animation.addByPrefix('redScroll', 'error');
								animation.addByPrefix('blueScroll', 'error');
								animation.addByPrefix('purpleScroll', 'error');
